...
# Goal: keep the full 94-ticker all-stock universe and improve coverage toward 94/94.
# scripts/build_report_safe.py refreshes missing coverage first, then rotates updates
# so the free Tiingo API is less likely to hit HTTP 429.
# Workflow trigger: 2026-07-09T10:30:00-04:00
